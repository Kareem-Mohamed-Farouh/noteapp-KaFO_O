...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">noteapp documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/MessagealertComponent.html" data-type="entity-link" >MessagealertComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/ModelComponent.html" data-type="entity-link" >ModelComponent</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/AuthAbstraction.html" data-type="entity-link" >AuthAbstraction</a>
                            </li>
                            <li class="link">
                                <a href="classes/authEndpoints.html" data-type="entity-link" >authEndpoints</a>
                            </li>
                            <li class="link">
                                <a href="classes/UserAbstract.html" data-type="entity-link" >UserAbstract</a>
                            </li>
                            <li class="link">
                                <a href="classes/userEndpoints.html" data-type="entity-link" >userEndpoints</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            <li class="link">
                                <a href="interfaces/IUsernotedata.html" data-type="entity-link" >IUsernotedata</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
